...
class LeaderboardRoute extends RouteBase implements Route {
	public function getSlug(): string {
		return self::LEADERBOARD_ROUTE;
	}
	...
	public function __invoke(Player $player, UserEntity $userEntity, array $userPermissions, ?array $params = null) {
		...
		$this->setCollection(CollectionFactory::get(CollectionSlug::LEADERBOARD_COLLECTION)->init($this->getPlayer(), $this->getUserEntity()));
	...
	protected function getForm(): SimpleForm {
		...
		$menu->setTitle(Utils::getText($this->getUserEntity()->getName(), "LEADERBOARD_TITLE"));
		return $menu;
	}
}