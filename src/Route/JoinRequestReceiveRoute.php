...
class JoinRequestReceiveRoute extends RouteBase {
	...
	public function getSlug(): string {
		return self::JOIN_REQUEST_RECEIVE_ROUTE;
	}
	...
	public function __invoke(Player $player, UserEntity $userEntity, array $userPermissions, ?array $params = null) {
		...
		$this->setCollection(CollectionFactory::get(CollectionSlug::JOIN_REQUEST_RECEIVE_COLLECTION)->init($this->getPlayer(), $this->getUserEntity(), $requests));
