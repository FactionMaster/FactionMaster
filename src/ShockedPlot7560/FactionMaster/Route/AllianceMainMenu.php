...
class AllianceMainMenu extends RouteBase implements Route {
    ...
    public function __invoke(Player $player, UserEntity $userEntity, array $userPermissions, ?array $params = null) {
        ...
        $this->setCollection(CollectionFactory::get(ManageAllianceMainCollection::SLUG)->init($this->getPlayer(), $this->getUserEntity(), $this->getFaction()));
