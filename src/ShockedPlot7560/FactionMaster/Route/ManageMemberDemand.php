...
use ShockedPlot7560\FactionMaster\Button\Collection\ManageRequestCollection;
use ShockedPlot7560\FactionMaster\Database\Entity\InvitationEntity;
use ShockedPlot7560\FactionMaster\Database\Entity\UserEntity;
use ShockedPlot7560\FactionMaster\Permission\PermissionIds;
use ShockedPlot7560\FactionMaster\Utils\Utils;

class ManageMemberDemand extends InvitationBase implements Route {
    ...
    public function getBackRoute(): ?Route {
        return RouterFactory::get(MemberDemandList::SLUG);
    }
    ...
    public function __invoke(Player $player, UserEntity $userEntity, array $userPermissions, ?array $params = null) {
        ...
        $this->setCollection(CollectionFactory::get(ManageRequestCollection::SLUG)->init($this->getPlayer(), $this->getUserEntity(), $this->getInvitation()));
