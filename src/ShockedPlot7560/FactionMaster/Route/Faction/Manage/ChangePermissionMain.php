...
class ChangePermissionMain implements Route {
    ...
    public function __invoke(Player $player, UserEntity $User, array $UserPermissions, ?array $params = null)
    {
        ...
        $this->Collection = ButtonFactory::get(PermissionMainCollection::SLUG)->init($player, $User);
    ...
    private function changePermissionMenu(string $message = "") : SimpleForm {
        ...
        if ($this->UserEntity->rank == Ids::RECRUIT_ID) $message .= Utils::getText($this->UserEntity->name, "NO_RANK");
