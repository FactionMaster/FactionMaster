...
class ManageAllianceInvitation implements Route {
    ...
    public function __invoke(Player $player, ?array $params = null)
    {
        ...
        $this->buttons = [];
        if ((array_key_exists(Ids::PERMISSION_DELETE_PENDING_ALLIANCE_INVITATION, $permissions) && $permissions[Ids::PERMISSION_DELETE_PENDING_ALLIANCE_INVITATION]) || $UserEntity->rank == Ids::OWNER_ID) $this->buttons[] = "§cDelete the invitation";
        $this->buttons[] = "§4Back";
