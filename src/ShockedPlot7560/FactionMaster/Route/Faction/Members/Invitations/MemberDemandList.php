...
class MemberDemandList implements Route {
    ...
    public function __invoke(Player $player, UserEntity $User, array $UserPermissions, ?array $params = null)
    {
        ...
        $this->Collection = ButtonFactory::get(ManageRequestListCollection::SLUG)->init($player, $User, $this->Requests);
        
        $message = "";
        if (isset($params[0])) $message = $params[0];
        if (count($this->Requests) == 0) $message .= Utils::getText($this->UserEntity->name, "NO_PENDING_REQUEST");
